const generators = {
  ...
  enemy: () => {
    ...
    const abilities = [
      ...
      'weaponizes player's healing items'
    ];
  ...
  item: () => {
    ...
    const effects = [
      ...
      'adapts to wielder\'s emotional state',
      ...
      'bends probability in user\'s favor',
  ...
  npc: () => {
    ...
    const quirks = [
      ...
      'remembers only things that haven\'t happened',
  ...
  gameJamTheme: () => {
    const themes = [
      ...
      'The Color of Sound', 'Yesterday\'s Tomorrow', 'Almost Perfect',
